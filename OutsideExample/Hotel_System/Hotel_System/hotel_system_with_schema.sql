...
-- -----------------------------------------------------
-- Schema rakurs_devices
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `hotel_system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `hotel_system` ;
...
CREATE TABLE `clients` (
  `id` int(11) NOT NULL,
  `first_name` varchar(100) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `last_name` varchar(100) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `phone` varchar(100) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `country` varchar(100) COLLATE utf8mb4_0900_ai_ci NOT NULL
...
CREATE TABLE `rooms` (
  ...
  `phone` varchar(100) COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `free` varchar(10) COLLATE utf8mb4_0900_ai_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `rooms_type` (
  `id` int(11) NOT NULL,
  `label` varchar(200) COLLATE utf8mb4_0900_ai_ci NOT NULL,
